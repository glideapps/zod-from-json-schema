...
export class TupleItemsHandler implements RefinementHandler {
    apply(zodSchema: z.ZodTypeAny, schema: JSONSchema.BaseSchema): z.ZodTypeAny {
        ...
        if (zodSchema instanceof z.ZodTuple || 
            (zodSchema instanceof z.ZodUnion && zodSchema._def.options.some((o: any) => o instanceof z.ZodTuple))) {
            ...
            if (zodSchema instanceof z.ZodUnion) {
                const options = zodSchema._def.options.map((o: any) => 
                    o instanceof z.ZodTuple ? tuple : o
                );
